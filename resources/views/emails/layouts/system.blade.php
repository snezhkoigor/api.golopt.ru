...
<html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]--><head>
    ...
    <style>.pkt_added {text-decoration:none !important;}</style><style></style></head>
<!--[if mso]>
<body class="mso">
<![endif]-->
<!--[if !mso]><!-->
            ...
            <div role="banner">
                ...
                <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                    ...
                    <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                        <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 167px;" src="https://i1.createsend1.com/ei/j/51/0DE/626/221736/csfinal/logo.png" alt="" width="167"></div>
                    </div>
                    <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                </div>
            </div>
            <div role="section">
                ...
                <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #fff;">
                        ...
                        <div class="column" style="text-align: left;color: black;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                    <div style="font-size: 12px;line-height: 19px;Margin-top: 18px;">
                                        <div style="font-size: 9px">
                                            Вы получили это письмо, потому что ранее регистрировались на сайте. Если это письмо вам пришло по ошибке, то вы можете отписаться по ссылке ниже.
                                        </div>
                                    </div>
                                    <!--[if mso]>&nbsp;<![endif]-->
                                </div>
                            ...
                            <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                    <div style="font-size: 12px;line-height: 19px;">
                                        <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;" href="{{config('app.url')}}/unsubscribe/">Отписаться</a>
                                    </div>
                                </div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
...
<img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;" src="https://golopt.createsend1.com/t/j-o-ukdtwy-l/o.gif" width="1" height="1" border="0" alt="">
